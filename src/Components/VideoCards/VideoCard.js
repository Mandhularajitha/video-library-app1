...
export const VideoCard = () => {
  ...
  const {playListDispatch,addToPlayList} = usePlayList();
  ...
  return (
    ...
    {modalVisible && (
        <div className="modal-wrapper">
          ...
          ></div>
          <div className="main-modal"><Modal /></div>
        </div>
      )}
        ...
        <div className="videos__container">
          {videos.map((video) => {
            ...
            return (
                ...
                <div className="videos__container" key={_id} onClick={()=>addToHistory(video,historyDispatch)}>
                  <div className="video">
                    ...
                    <div className="icons_1">
                        <div className="border_radios">
                          <div className="border_radios_2" onClick={()=>addToLike(video,likedDispatch)}>
                        
                            <i className="material-icons">thumb_up</i>
                          </div>

                          <div className="border_radios_2" onClick={()=>addToWatchlater(video,watchLaterDispatch)}>
                            <i className="material-icons">watch_later</i>
                          </div>

                          <div className="border_radios_2" onClick={()=>setModalVisible(state=>!state)}>
